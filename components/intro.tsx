...
import CvPicture from "@/public/CvPicture.jpg";
...
export default function Intro() {
  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-48 w-48 rounded-full border-[0.35rem]
      ...
      <motion.h1
        className="mb-10 mt-4 px-5 text-xl 
      font-medium !leading-[1.5] sm:text-3xl"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <span className="font-bold">Hi! My name is Attila Bence Szalai</span>{" "}
        and I'm a freshly graduated{" "}
        <span className="font-bold">software engineer.</span> I'm passionate
        about <span className="font-bold">frontend development</span>, and I'm
        always looking for new challenges. I'm working with{" "}
      ...
      >
        ...
        <a
          href="https://github.com/sz-attila"
          className="bg-white p-4 text-gray-700
        flex items-center gap-2 text-[1.35rem] rounded-full outline-none focus:scale-[1.15]
        hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack"
        >
          <FaGithubSquare />
        </a>
